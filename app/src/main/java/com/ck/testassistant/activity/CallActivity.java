...
import com.ck.testassistant.service.CallService;
...
public class CallActivity extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        EditText et_phone = findViewById(R.id.et_ca_phone_ref_num);
    ...
    public void Call(View view) {
        phone = findViewById(R.id.et_ca_phone_ref_num);
        phoneNum = phone.getText().toString();
        etTimes = findViewById(R.id.et_ca_total);
        times = Integer.parseInt(etTimes.getText().toString());
        etFrequency = findViewById(R.id.et_ca_frequency);
